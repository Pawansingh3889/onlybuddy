...
export function SectionTitle({ children, action }) {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, color: theme.text, fontFamily: "'Outfit', sans-serif" }}>{children}</h2>
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: 18, fontWeight: 800, color: theme.text, fontFamily: "'Outfit', sans-serif", lineHeight: 1.2 }}>{title}</div>
